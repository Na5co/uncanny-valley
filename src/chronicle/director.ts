...
export const DIRECTOR_SYSTEM = [
  ...
  "{\"headline\": \"one short line, under 12 words, plain\", \"text\": \"two or three plain sentences: what happens this season and what it means for the town\", \"supply\": number from -0.15 to 0.15 (what it does to the town's food stores; 0 if nothing), \"mood\": number from -0.1 to 0.1 (what it does to everyone's spirits), \"sick\": [ids of the four it makes sick, only if it is a sickness, at most one], \"favour\": [up to three choice ids from the list that this event makes likely this season], \"touch\": [{\"id\": one of the four, \"mood\": -0.15 to 0.15, \"why\": \"a few words\"}] (who it lands on hardest; may be empty), \"sets\": optional {\"what\": \"...\", \"in\": 1-4}, \"closes\": optional thread id, \"exposes\": optional secret id, \"kind\": the kind of turn you wrote}",
  "Plain words: no poetry, no metaphors. The headline is what a person in the town would say happened.",
